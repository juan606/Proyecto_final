...
void display(void)
{
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.302f, 0.098f, 0.058f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.454f, 0.0f));
	sphere_draw();
	...
	model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.9f, 0.9f, 0.9f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.4f, 0.0f, 0.0f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.576f, 0.447f, 0.333f));
	sphere_draw();
	...
	model = glm::rotate(model, glm::radians(saturno), glm::vec3(0.0f, 0.0f, 1.0f));
	model = glm::scale(model, glm::vec3(1.4f, 0.01f, 1.4f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.0f, 0.7f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.063f, 0.541f, 0.769f));
	sphere_draw();
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.619f, 0.866f, 1.0f));
	sphere_draw();
